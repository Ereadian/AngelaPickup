...
public static class VariableNames
{
    ...
    public const string CurrentFileNameNoExtension = "current-file-name-without-extension";
    public const string CurrentFileCreationTime = "current-file-creation-time";
    public const string CurrentFileLastModifiedTime = "current-file-modified-time";
